...
knots~\cite{knots}                  & C/C++, Rust, Py, JS, TS & CC, Cognitive, Nesting, SLOC, ABC, AIRD, AICP, + 4 more & \checkmark & \checkmark & \checkmark & Fast \\
\bottomrule
\end{tabular}
...
supports C, C++, Rust, Python, JavaScript, TypeScript, and TSX via
